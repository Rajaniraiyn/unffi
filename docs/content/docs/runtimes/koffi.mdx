---
title: Node.js (koffi)
description: Using unffi with the koffi backend on Node.js — structs, output params, opaque handles, wide strings.
---

Node.js has no stable built-in FFI before v26.3.0. unffi uses [koffi](https://koffi.dev) — a pre-compiled native addon, no build step. It installs as an optional peer dependency.
