...
These modules use the same schema inference and `await using` lifecycle as manual `dlopen`. See [System libraries](/docs/system-libraries) for the platform reference.
